...
>
  ...
  <option value="Tenant C">Tenant C</option>
      ...
      <nav class="flex-1 space-y-1">
        <router-link to="/" class="block p-2 rounded-md hover:bg-gray-100 text-gray-600" active-class="bg-blue-50 text-blue-700 font-semibold">Home</router-link>
        <router-link to="/security" class="block p-2 rounded-md hover:bg-gray-100 text-gray-600" active-class="bg-blue-50 text-blue-700 font-semibold">Security & Access</router-link>
        </nav>
      ...
      <div class="border-t border-gray-100 pt-4 space-y-1">
        ...
        >
          <span>Settings</span>
          <span class="text-xs transition-transform" :class="{ 'rotate-180': isSettingsOpen }">▼</span>
        </button>
        ...
        <router-link to="/help" class="block p-2 rounded-md hover:bg-gray-100 text-gray-600" active-class="bg-blue-50 text-blue-700 font-semibold">Help</router-link>
        <router-link to="/user" class="block p-2 rounded-md hover:bg-gray-100 text-gray-600" active-class="bg-blue-50 text-blue-700 font-semibold">User</router-link>
      </div>
    </aside>
